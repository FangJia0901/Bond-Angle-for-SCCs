...
xyz_filepath_list = list(glob('/Users/fangjia/PycharmProjects/fj/Practice/champs-scalar-coupling/structures/*.xyz'))
xyz_filepath_list.sort()
print('total xyz filepath # ', len(xyz_filepath_list))
print("Start")

#pred_df_list_1J_df3 = pd.read_csv('/Users/fangjia/Desktop/pred_df_list_1J_df.csv')
#pred_df_list_1J_df3_list = list((pred_df_list_3J_df3['Mol_Name'].values))[::4]

#pred_df_list_3J_df3_list = list(f'/Users/fangjia/Desktop/test_structure/{i}.xyz' for i in pred_df_list_3J_df3_list)
#xyz_filepath_list = pred_df_list_3J_df3_list
####xyz_filepath_list = ['/Users/fangjia/Desktop/test_structure/dsgdb9nsd_113830.xyz',
###                    '/Users/fangjia/Desktop/test_structure/dsgdb9nsd_112475.xyz']
#print(xyz_filepath_list[-307])
...
img = Draw.MolsToGridImage(mol_list, molsPerRow=7, subImgSize=(150, 150), maxMols=num_mols, legends=None, useSVG=True)
#print(type(img))
#print(img)
img
